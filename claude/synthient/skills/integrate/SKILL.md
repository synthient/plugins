...
Read the field vocabularies and invariants from `/synthient:docs` before writing code.
...
Confirm the choice with the user before writing code. Where the check goes determines what the failure modes cost, and that is the user's call.
